...
public class PlantKoboldObjective : ObjectiveWithSpaceBeam
{
	...
	public override void Register()
	{
		...
		{
			PhotonNetwork.InstantiateRoomObject(eggPrefab.photonName, mailBox.transform.position, Quaternion.identity, 0, new object[1] { new KoboldGenes().Randomize() });
		}
	}
	...
	{
		return title.GetLocalizedString() + " " + plants + "/" + maxPlants;
	}
