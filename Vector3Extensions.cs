...
public static class Vector3Extensions
{
	...
	{
		float? y = 0f;
		return original.With(null, y);
	}

	public static Vector3 KillDepth(this Vector3 original)
	{
		float? z = 0f;
		return original.With(null, null, z);
	}
	...
	public static Mesh Copy(this Mesh mesh)
	{
		...
		NativeArray<BoneWeight1> weights = new NativeArray<BoneWeight1>(mesh.GetAllBoneWeights(), Allocator.Temp);
		NativeArray<byte> bonesPerVertex = new NativeArray<byte>(mesh.GetBonesPerVertex(), Allocator.Temp);
