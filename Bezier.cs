...
public static class Bezier
{
	...
	{
		float s = 1f - t;
		return startPosition * s * s * s + startTangent * s * s * t * 3f + endTangent * s * t * t * 3f + endPosition * t * t * t;
	}
	...
	{
		float s = 1f - t;
		return s * s * 3f * (startTangent - startPosition) + 6f * s * t * (endTangent - startTangent) + 3f * t * t * (endPosition - endTangent);
	}
